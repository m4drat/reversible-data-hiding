...
TEST(EmbedderTest, Image_4x4px_test) {
    ...
    BmpImage imageReference(ImageMatrix<Color8u>({
        {0b00000000, 0b11111001, 0b00100001, 0b00001111},
        {0b01001000, 0b11110000, 0b00000110, 0b10011001},
        {0b10100001, 0b10100011, 0b00000000, 0b10110000},
        {0b11001101, 0b10101010, 0b00010101, 0b00111110}
    }));
